...
Sou professor, instrutor e criador de conteúdo na área de IA e NoCode.
...
Crio conteúdos e projetos relacionados a:
...
Tenho trabalhado em diferentes projetos envolvendo IA, automações, Supabase, APIs, sistemas web e ferramentas digitais.

Um dos projetos em desenvolvimento é o **PedeSampa**, uma iniciativa voltada para soluções digitais para negócios locais de delivery, como restaurantes, pizzarias, hamburguerias e marmitarias.

A proposta do PedeSampa é explorar formas mais simples e acessíveis de criar presença digital, organizar pedidos e aproximar pequenos negócios de seus clientes.

Site:

[pedesampa.com.br](https://pedesampa.com.br)
...
| Backend e banco de dados | Supabase, PostgreSQL, SQL, APIs |
...
Estou em constante formação e evolução profissional.

Tenho estudado e aplicado inteligência artificial todos os dias, acompanhando novas ferramentas, modelos, agentes, automações e formas de usar IA para criar soluções práticas.

Meu interesse não está apenas em usar ferramentas prontas, mas em entender como elas podem ser combinadas para criar produtos, processos e experiências melhores.

Vejo a IA como uma ponte entre educação, criatividade, negócios e tecnologia.

## Áreas de interesse

| Tema | Foco |
|---|---|
| IA aplicada | Agentes, automações, geração de conteúdo e produtividade |
| Educação | Aulas, tutoriais, materiais e formação tecnológica |
| NoCode e LowCode | Criação rápida de soluções e protótipos |
